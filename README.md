...
The DreamerV3 reference implementation is a submodule pinned at one upstream commit. Checkpoints and
rendered datasets are too large for git and live at
...
uv run python scripts/fetch_assets.py --what-backs  # what each artifact backs, to fetch a subset
```
